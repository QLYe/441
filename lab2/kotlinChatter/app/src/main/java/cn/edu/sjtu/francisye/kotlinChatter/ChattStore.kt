                ...
                if (response.isSuccessful) {
                    ...
                    for (i in 0 until chattsReceived.length()) {
                        ...
                        if (chattEntry.length() == nFields) {
                            ...
                            Log.d("getChatts",chattEntry[0].toString())
                            Log.d("getChatts",chattEntry[1].toString())
                            Log.d("getChatts",chattEntry[2].toString())
                            Log.d("getChatts",chattEntry[3].toString())
                            Log.d("getChatts",chattEntry[4].toString())
                        } else {
